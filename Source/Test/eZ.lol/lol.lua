...
function OrionLib:MakeWindow(WindowConfig)
	...
	function OrionLib.SetTitle(Title)
		local fadeOutTween = TweenService:Create(WindowName, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {TextTransparency = 1})
		fadeOutTween:Play()
		fadeOutTween.Completed:Wait()
		WindowName.Text = Title
		local fadeInTween = TweenService:Create(WindowName, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {TextTransparency = 0})
		fadeInTween:Play()
	end
